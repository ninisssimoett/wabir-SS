...
// cek apakah id report benar benar ada
$report_id = $_GET['report_id'] ?? null;

if(!$report_id) {
    echo "id laporan tidk ditemukan";
    exit();
}

//cek form apakah sudah terisi ato belom
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    
    $feedback = $_POST['feedback'] ?? '';
    $petugas_id = $_SESSION['user_id'];  //$session = user yg sdg login

    //melakukan pengecekan ada isinya atau kosong = input textarea
    if(!empty($feedback)) {
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(90deg, #5473ed, #00c6ff);">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">wabir'S</div>
            </a>
            <!-- Divider -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="../boostrap/img/undraw_profile.svg">
                            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="card p-4 mb3">
                                        <form method="POST">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Feedback</label>
                                                <textarea name="feedback" placeholder="Masukan feedback anda" rows="3" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp"></textarea>
                                            </div>
