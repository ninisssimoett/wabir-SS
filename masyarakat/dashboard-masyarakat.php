...
$report_with_feedback = get_reports_with_feedback_by_user($_SESSION['username'], $conn);
           ...
           <div id="content">
               ...
               <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                       <h1 class="h3 mb-0 text-gray-800">haii !! selamat datang <?= $_SESSION['username'] ?> 👋🤩</h1>
                   </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-xl-12 col-lg-7">
                           <div class="card shadow mb-4">
                               ...
                               <!-- Card Body -->
                               <div class="card-body">
                                   <?php foreach($report_with_feedback as $p): ?>
                                       <div class="card p-4 mb-3">
                                           <strong>Tanggal Laporan : </strong>
